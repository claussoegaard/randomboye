...
class RandomBoye(object):
    ...
    def start(self):
        ...
        self.pi.front_button_latest_event = None
        self.pi.back_button_latest_event = None
    ...
    def front_button_relase_override(self):
        ...
        try:
            ...
            self.pi.front_button_latest_event = 'release'
